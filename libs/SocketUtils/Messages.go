...
type Messages struct {
	messageCommands map[string]int
	MSG_TYPE        map[string]int
	GroupType       map[string]int
	messagePacks    map[string]int
	inputting       string
}
